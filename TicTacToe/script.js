    ...
    cells[i].addEventListener("click", function() {
        if (!win) {
            ...
            if (checkWinner == "Circle") {
                winner.innerHTML = "<h1 style='color:#EB242A;'>Circle team Win!</h1>";
                circle_score.innerHTML = Number(circle_score.innerHTML) + 1;

            } else if (checkWinner == "Cross") {
                winner.innerHTML = "<h1 style='color:#22EB77;'>Cross team Win!</h1>";
                cross.innerHTML = Number(cross.innerHTML) + 1;

            } else if (end == 9) {
                winner.innerHTML = "<h1 style='color:#5E5B58;'>Draw!</h1>";
